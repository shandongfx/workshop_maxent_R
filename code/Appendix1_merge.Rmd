...
#####Thread 7
```{r clean data1}
# remove bad coordinates, where either the latitude or longitude is missing
...
# have the number one as the indicator for presence; rep(0,nrow(a)) 
# creating the number of rows as the a data set to have the number
# zero as the indicator for absence; the c combines these ones and 
...
## we may notice small difference, especially clamp shows higher predictions in most areas.
```
